...
func TestFetchArticle(t *testing.T) {
	tests := []struct {
		...
		{
			"https://cn.reuters.com/article/hainan-crypto-mining-regs-0603-idCNKCS2DF11S",
			ErrTimeOverDays,
		},
		{
			"https://cn.reuters.com/article/asia-financial-markets-0609-wedn-idCNKCS2DL08V",
			nil,
		},
	}
...
func TestFetchTitle(t *testing.T) {
	tests := []struct {
		...
		{"https://www.reuters.com/realtime/world/story20210602-1151196", "马国男子腰缠巨蟒骑摩托车送往放生引热议"},
		{"https://www.reuters.com/realtime/world/story20210607-1153241", "以色列将于14日前投票批准新政府"},
	}
	for _, tc := range tests {
		a := NewArticle()
...
func TestFetchUpdateTime(t *testing.T) {
	tests := []struct {
		...
		{
			"https://www.reuters.com/realtime/world/story20210602-1151196",
			"2021-06-02 15:44:33 +0800 UTC",
		},
		{
			"https://www.reuters.com/realtime/world/story20210607-1153241",
